...
CREATE TABLE `blogcategorys` (
  `id` int(11) NOT NULL,
  `blogcategoryname` varchar(512) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `blogcategorys` */

insert  into `blogcategorys`(`id`,`blogcategoryname`) values (1,'财经'),(2,'社会');

/*Table structure for table `blogdb` */

DROP TABLE IF EXISTS `blogdb`;

CREATE TABLE `blogdb` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `blogname` varchar(512) DEFAULT NULL,
  `author` char(50) CHARACTER SET utf8 NOT NULL,
...
insert  into `django_migrations`(`id`,`app`,`name`,`applied`) values (1,'contenttypes','0001_initial','2015-05-10 15:31:02'),(2,'auth','0001_initial','2015-05-10 15:31:13'),(3,'admin','0001_initial','2015-05-10 15:31:17'),(4,'blog','0001_initial','2015-05-10 15:31:18'),(5,'blog','0002_auto_20150509_2310','2015-05-10 15:31:21'),(6,'blog','0003_auto_20150510_2314','2015-05-10 15:31:21'),(7,'sessions','0001_initial','2015-05-10 15:31:22'),(8,'sites','0001_initial','2015-05-10 15:31:22'),(9,'blog','0004_auto_20150514_0037','2015-05-13 16:37:23');
